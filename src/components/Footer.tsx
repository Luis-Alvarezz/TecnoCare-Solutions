...
export const Footer = () => {
  return (
    <footer className="bg-amber-900 py-5 mt-20">
      ...
      <div className="sm:grid sm:grid-cols-1 md:grid md:grid-cols-3 md:justify-between md:gap-2 md:max-w-7xl md:mx-auto text-center items-center"> {/* text-center -> Alinear verticalmente  item-center -> Alinear Horizontalmente */}
